...
unix: LIBS += -lqwt -lqmqtt# Añadido Necesario para encontrar implementación de librerias!!

win32: LIBS += -lqwtd -lqmqttd# Añadido Necesario para encontrar implementación de librerias!!
